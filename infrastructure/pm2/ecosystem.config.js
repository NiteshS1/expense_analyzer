...
module.exports = {
  ...
  deploy: {
    production: {
      ...
      'post-deploy':
        'npm install && npm run build && pm2 reload infrastructure/pm2/ecosystem.config.js --env production',
    ...
    staging: {
      ...
      'post-deploy':
        'npm install && npm run build && pm2 reload infrastructure/pm2/ecosystem.config.js --env development',
    },
  },
};
